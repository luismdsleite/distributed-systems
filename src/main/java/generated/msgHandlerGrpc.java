...
public final class msgHandlerGrpc {
  ...
  public static final String SERVICE_NAME = "proto.msgHandler";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<generated.MsgHandler.Msg,
      generated.MsgHandler.Empty> getSendMsgMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMsg",
      requestType = generated.MsgHandler.Msg.class,
      responseType = generated.MsgHandler.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.MsgHandler.Msg,
      generated.MsgHandler.Empty> getSendMsgMethod() {
    io.grpc.MethodDescriptor<generated.MsgHandler.Msg, generated.MsgHandler.Empty> getSendMsgMethod;
      ...
      synchronized (msgHandlerGrpc.class) {
        if ((getSendMsgMethod = msgHandlerGrpc.getSendMsgMethod) == null) {
          msgHandlerGrpc.getSendMsgMethod = getSendMsgMethod =
              io.grpc.MethodDescriptor.<generated.MsgHandler.Msg, generated.MsgHandler.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendMsg"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.MsgHandler.Msg.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.MsgHandler.Empty.getDefaultInstance()))
  ...
  public static abstract class msgHandlerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMsg(generated.MsgHandler.Msg request,
        io.grpc.stub.StreamObserver<generated.MsgHandler.Empty> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                generated.MsgHandler.Msg,
                generated.MsgHandler.Empty>(
  ...
  public static final class msgHandlerBlockingStub extends io.grpc.stub.AbstractBlockingStub<msgHandlerBlockingStub> {
    ...
    /**
     */
    public generated.MsgHandler.Empty sendMsg(generated.MsgHandler.Msg request) {
  ...
  public static final class msgHandlerFutureStub extends io.grpc.stub.AbstractFutureStub<msgHandlerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.MsgHandler.Empty> sendMsg(
        generated.MsgHandler.Msg request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MSG:
          serviceImpl.sendMsg((generated.MsgHandler.Msg) request,
              (io.grpc.stub.StreamObserver<generated.MsgHandler.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class msgHandlerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return generated.MsgHandler.getDescriptor();
    }
